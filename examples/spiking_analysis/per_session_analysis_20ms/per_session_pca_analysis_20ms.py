...
def main():    
    ...
    for day in days:
        ...
        data = utils.construct_dataset(pos, features=vel, graph_type='cknn', k=30, stop_crit=0.02, delta=2.0,
        ...
        with open('./outputs/distance_matrices_and_embeddings_20ms_sc02.pkl', 'wb') as handle:
            pickle.dump([distance_matrices, embeddings, times , all_condition_labels, train_distance_matrices, train_embeddings ], handle, protocol=pickle.HIGHEST_PROTOCOL)
